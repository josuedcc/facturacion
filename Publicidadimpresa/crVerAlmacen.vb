...
Public Class crVerAlmacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Publicidadimpresa.crVerAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrVerAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crVerAlmacen = New crVerAlmacen()
        rpt.Site = Me.Site
        Return rpt
    End Function
